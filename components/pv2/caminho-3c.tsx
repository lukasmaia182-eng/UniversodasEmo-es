...
const steps = [
  {
    icon: Lightbulb,
    title: "Conocer",
    text: "El niño descubre el nombre de la emoción y entiende que lo que siente tiene un significado.",
  ...
  },
  {
    icon: HeartHandshake,
    title: "Conectar",
    text: "Percibe cuándo aparece esa emoción, en qué situaciones surge y cómo puede sentirla en el cuerpo.",
  ...
  },
  {
    icon: MessagesSquare,
    title: "Conversar",
    text: "Con historias, juegos y actividades, el niño gana formas más ligeras de expresar lo que pasa por dentro.",
    tone: "bg-lavender/30 text-lavender-foreground",
    badge: "bg-lavender text-lavender-foreground",
  },
]

export function Caminho3cPv2() {
  return (
      ...
      <Reveal>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 text-balance font-heading text-3xl font-semibold leading-tight text-foreground md:text-4xl">
            El camino 3C de las emociones
          </h2>
          <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
            El Universo de las Emociones™ fue pensado para ayudar al niño a pasar por tres etapas simples: conocer,
